            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mt-2">
                                <img src="<?= base_url() ?>/assets/images/flags/us_flag.jpg" alt="" class="mb-2"
                                    height="30">
                                <h5 class="mb-3">Our most customers in America <span class="badge badge-primary">March
                                        2019</span></h5>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    ...
                                    <h3 class="mt-0"><img src="<?= base_url() ?>/assets/images/flags/us_flag.jpg" alt=""
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img class="" src="<?= base_url() ?>/assets/images/products/img-1.png"
                                            alt="user">
                                    </td>
                                    <td>
                                        Beg
                                ...
                                <tr>
                                    <td>
                                        <img class="" src="<?= base_url() ?>/assets/images/products/img-2.png"
                                            alt="user">
                                    </td>
                                    <td>
                                        Watch
                                ...
                                <tr>
                                    <td>
                                        <img class="" src="<?= base_url() ?>/assets/images/products/img-3.png"
                                            alt="user">
                                    </td>
                                    <td>
                                        Headphone
                                ...
                                <tr>
                                    <td>
                                        <img class="" src="<?= base_url() ?>/assets/images/products/img-4.png"
                                            alt="user">
                                    </td>
                                    <td>
                                        Purse
                                ...
                                <tr>
                                    <td>
                                        <img class="" src="<?= base_url() ?>/assets/images/products/img-5.png"
                                            alt="user">
                                    </td>
                                    <td>
                                        Shoe
                                ...
                                <tr>
                                    <td>
                                        <img class="" src="<?= base_url() ?>/assets/images/products/img-6.png"
                                            alt="user">
                                    </td>
                                    <td>
                                        Boll
                ...
                <div class="card-body dash-info-carousel">
                    <div id="carousel_best_saler" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="text-center">
                                    <img src="<?= base_url() ?>/assets/images/users/user-4.jpg" alt="user"
                                    ...
                                    <div class="mt-2 align-item-center">
                                        <h5 class="font-20 d-inline-block mb-0 mr-3 align-self-center">
                                            $34800.00</h5>
                                        <a class="btn btn-sm btn-primary text-light mb-2"><i
                            ...
                            <div class="carousel-item">
                                <div class="text-center">
                                    <img src="<?= base_url() ?>/assets/images/users/user-2.jpg" alt="user"
                                        class="rounded-circle thumb-xl img-thumbnail mb-1">
                ...
                <div class="card-body dash-info-carousel">
                    <div id="carousel_review" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="media">
                                    <img src="<?= base_url() ?>/assets/images/flags/us_flag.jpg"
